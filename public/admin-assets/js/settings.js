var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="/admin-assets/css/theme-default.css"><img src="/admin-assets/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="/admin-assets/css/theme-forest.css"><img src="/admin-assets/img/themes/forest.jpg"/></a>'
            +'<a href="#" data-theme="/admin-assets/css/theme-dark.css"><img src="/admin-assets/img/themes/dark.jpg"/></a>'                        
            +'<a href="#" data-theme="/admin-assets/css/theme-night.css"><img src="/admin-assets/img/themes/night.jpg"/></a>'            
            +'<a href="#" data-theme="/admin-assets/css/theme-serenity.css"><img src="/admin-assets/img/themes/serenity.jpg"/></a>'
            
            +'<a href="#" data-theme="/admin-assets/css/theme-default-head-light.css"><img src="/admin-assets/img/themes/default-head-light.jpg"/></a>'
            +'<a href="#" data-theme="/admin-assets/css/theme-forest-head-light.css"><img src="/admin-assets/img/themes/forest-head-light.jpg"/></a>'    
            +'<a href="#" data-theme="/admin-assets/css/theme-dark-head-light.css"><img src="/admin-assets/img/themes/dark-head-light.jpg"/></a>'            
            +'<a href="#" data-theme="/admin-assets/css/theme-night-head-light.css"><img src="/admin-assets/img/themes/night-head-light.jpg"/></a>'
            +'<a href="#" data-theme="/admin-assets/css/theme-serenity-head-light.css"><img src="/admin-assets/img/themes/serenity-head-light.jpg"/></a>'
